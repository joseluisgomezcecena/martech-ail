            ...
            <div id="profile-data" class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-lg-3">
                          ...
                          <select  name="user_department" id="" class="form-control">
                            ...
                            ?>
                                <option value="<?php echo $row1['department_id'] ?>" <?php if($row['user_department'] == $row1['department_id']){echo "selected";}else{echo "";} ?>><?php echo $row1['department_name'] ?></option>
                            <?php endwhile; ?>
                          </select>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-lg-4">
                        ...
                        <label class="switch1 ">
                          <input name="user_level" type="checkbox" class="primary" <?php  echo $row['user_level']== 0 ? '':'checked' ?>>
                          <span class="slider1 round"></span>
                        </label>
                      </div>
