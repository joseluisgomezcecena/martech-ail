                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" name="meeting" id="" class="form-control" value="<?php if(isset($_POST['meeting'])){echo $_POST['meeting'];}else{if(isset($data['meeting_name'])){echo $data['meeting_name'];}else{echo "";};} ?>" required>
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" name="meeting_date" id="" class="form-control datepicker" value="<?php if(isset($_POST['meeting_date'])){echo $_POST['meeting_date'];}else{if(isset($data['meeting_date'])){echo $data['meeting_date'];}else{echo "";};} ?>" required>
                        </div>

                        <div class="form-group col-lg-12">
                            <p>Private</p>
                            <label class="switch1 ">
                            <input name="private" type="checkbox" class="primary" <?php if(isset($data['private']) && $data['private'] == 1){echo"checked";}else{echo "";} ?>>
                            <span class="slider1 round"></span>
                            </label>
                            <small>Private Meetings are only visible to users with Admin Level, users who have actions for these meetings.</small>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div style="width: 100%;" id="userRefresh">                

                        <div class="form-group col-lg-12">
                            <label for="id_label_single">Action Owner</label>
                            <select style="width: 100%;" class=" js-example-basic-single form-control" id="id_label_single" name="owner" required>
                                <?php 
                        ...
                        <div class="form-group col-lg-12">
                            <label>ECD</label>
                            <input type="text" name="ecd" id="" class="form-control datepicker" value="<?php if(isset($_POST['project_start_date'])){echo $_POST['project_start_date'];} ?>" required>
                        </div>

                        <div class="form-group col-lg-12">
                            <button style="float: left;" id="edit_profile1" name="add_action" type="submit" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm ">
                                <i class="fas fa-plus fa-lg text-white-50"></i>&nbsp;&nbsp;Add Action
                            </button>
                        </div>
                        ...
                        <table class="table">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary modal-action-edit" data-action-id="<?php echo $row['ail_action_id'] ?>" data-action-name="<?php echo $row['ail_action_name'] ?>"   data-issue-name="<?php echo $row['ail_issue_name'] ?>"   data-ecd="<?php echo $row['ail_action_ecd'] ?>"   data-owner="<?php echo $row['ail_owner'] ?>"  data-array="<?php $sql_array = "SELECT * FROM ail_users WHERE ail_action_id = {$row['ail_action_id']}"; $run_sql_array = mysqli_query($connection,$sql_array); while($row_array = mysqli_fetch_array($run_sql_array)){echo "{$row_array['ail_user_id']},";} ?>" data-toggle="modal" data-target="#exampleModal">
                                                    Update
                                            </button>

                                            <button type="button" class="btn btn-danger modal-action-delete" data-action-id="<?php echo $row['ail_action_id'] ?>" data-action-name="<?php echo $row['ail_action_name'] ?>" data-toggle="modal" data-target="#deleteModal">
                                                    Delete
                                            </button>

                                            <!--
                                            <a href="<?php echo $row['ail_action_id'] ?>" class="btn btn-primary">Update</a>
                                            <a href="<?php echo $row['ail_action_id'] ?>" class="btn btn-danger">Delete</a>
                                            -->
                                        </td>
                                    </tr>
                            <?php 
