        ...
        <script type='text/javascript'>
          document.addEventListener('DOMContentLoaded', function(event) {
            ...
            swal({
                ...
                window.location = 'index.php?page=tier_view&tier_id=$p&area_id=$a';
            });
          });
       </script>
       ";
...
$stmt = $connection->prepare("SELECT * FROM tiers WHERE tier_id = ?");
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="index.php?page=tier_view&project_id=<?php echo $_GET['tier_id'] ?>">View <?php echo $row['tier_name']; ?></a></li>
    <li class="breadcrumb-item active" aria-current="page">Add An Action</li>
  </ol>
</nav>
