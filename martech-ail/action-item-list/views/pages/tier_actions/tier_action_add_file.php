...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.php?page=tier_list">Back To Project List</a></li>
            ...
            <div id="profile-data" class="card-body">
                ...
                <div class="col-lg-8 offset-lg-2">
                  <form id="imageUploadForm2">
                    ...
                    <div id="imageUpload2" class="dropzone"></div>
                    
                    <div style="margin-top: 15px;" class="form-group">
                      <button style="float: right;" id="uploaderBtn2" type="button" class="btn btn-primary">Upload Files</button>
                    </div>
                  </form>   
                </div>
                ...
                <div class="col-lg-8 offset-lg-2">
                  <div style="margin-top: 100px;" id="fileList">
                      ...
                      <?php 
                      $query = "SELECT * FROM tier_action_files WHERE file_active = 1 AND file_action_id = {$_GET['action_id']} AND file_user_id = {$_SESSION['quatroapp_user_id']} ORDER BY file_id DESC";
