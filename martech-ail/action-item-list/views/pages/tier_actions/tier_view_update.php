...
<div style="margin-bottom:15px;">
    <a  href="index.php?page=tier_action_add_file&action_id=<?php echo $row['action_id']; ?>&tier_id=<?php echo $row['tier_id'] ?>" id="add-newuser" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" ><i class="fas fa-plus fa-sm text-white-50"></i>&nbsp;&nbsp;Add File</a>
    <a  href="index.php?page=tier_action_progress&action_id=<?php echo $row['action_id']; ?>&tier_id=<?php echo $row['tier_id'] ?>" id="add-newuser" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" ><i class="fas fa-plus fa-sm text-white-50"></i>&nbsp;&nbsp;Update Progress</a>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.php?page=tier_view&tier_id=<?php echo $row['action_tier_id'] ?>">Back To Actions List</a></li>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <br>
                        <b>Tier: </b><?php echo $row['tier_name']; ?>
                        <br>
                        <b>Responsible Department: </b><?php echo $row['department_name']; ?>
                        <br>
                        <b>Start Date: </b><?php echo date_format(date_create($row['action_start_date']), "m-d-Y"); ?>
                        <br>
                        <b>Promise Date: </b><?php echo date_format(date_create($row['action_promise_date']), "m-d-Y"); ?>
                        <br>
                        ...
                        ?>
                        <div data-toggle='tooltip' data-placement='top' title='<?php echo  $percentage . "% Complete"?>' class="progress">
                        ...
                        <br>
                        <b>Progress: </b><?php echo $percentage."% Complete"; ?>
                        <br>
                        <b>Time Status:</b>
                        <?php
                            if($row['action_status'] == 0 && $row['action_promise_date'] <= date("Y-m-d"))
                            {
                                echo "<i class='fa fa-times text-danger'></i>&nbsp;Late";
                            }   
                            elseif($row['action_status'] == 0 && $row['action_promise_date'] > date("Y-m-d"))
                            {
                                echo "<i class='fa fa-check text-success'></i>&nbsp;On Time";
                            }
                        ?>
                    </div>
                    <div class="col-lg-6">
    ...
    <div class="card-header py-3">
        ...
        <div class="card-body">
            ...
            <table  style="font-size: 14px; vertical-align:middle; " class="table  order-column " id="dataTableExcel" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php 
                    $query = "SELECT * FROM tier_action_updates
                    ...
                    WHERE tier_action_updates.a_update_action_id = {$_GET['action_id']}";
    ...
    <div class="card-header py-3">
        ...
        <div class="card-body">
            ...
            <table  style="font-size: 14px; vertical-align:middle; " class="table  order-column " id="example1" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php 
                    $query = "SELECT * FROM tier_action_files WHERE file_action_id = {$_GET['action_id']}";
                    $result = mysqli_query($connection, $query);
                    while($row = mysqli_fetch_array($result)):
                    ?>
                        <tr>
    ...
    <div class="card-header py-3">
        ...
        <div class="card-body">
            ...
            <table  style="font-size: 14px; vertical-align:middle; " class="table  order-column " id="example1" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php 
                    $query = "SELECT COUNT(*) as cuenta, a_update_user, user_name, user_image FROM tier_action_updates 
                    LEFT JOIN users ON tier_action_updates.a_update_user = users.user_id WHERE a_update_action_id = {$_GET['action_id']} GROUP by users.user_name
                    ";
                    $result = mysqli_query($connection, $query);
                    while($row = mysqli_fetch_array($result)):
                    ?>
