        ...
        <script type='text/javascript'>
          document.addEventListener('DOMContentLoaded', function(event) {
            ...
            swal({
                ...
                window.location = 'index.php?page=tier_view_update&action_id=$p';
            });
          });
       </script>
       ";
...
$stmt2 = $connection->prepare("SELECT * FROM tier_action_updates WHERE a_update_id = ?");
$stmt2->bind_param("i", $_GET['update_id']);
$stmt2->execute();
        ...
        <div class="card shadow mb-4">
            ...
            <div id="profile-data" class="card-body">
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="form-group">
                        <label>Update</label>
                        <textarea name="action_update" id="" class="form-control" rows="7" required><?php  $string_stripped = strstr($row2['a_update_descr'], ':'); echo substr($string_stripped, 2); ?></textarea>
                        <small>Date of update will be saved automatically once you click on Save Update.</small>
                    </div>

                                  
                    <div class="form-group right">
                        <button style="float: right;" id="edit_profile1" name="edit_update" type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm ">
                            <i class="far fa-save fa-lg text-white-50"></i>&nbsp;&nbsp;Update Data
                        </button>
                    </div>
