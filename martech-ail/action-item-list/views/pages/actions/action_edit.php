...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="index.php?page=project_view&project_id=<?php echo $row_data['action_project_id'] ?>">View <?php echo $row_data['action_name']; ?></a></li>
            ...
            <div id="profile-data" class="card-body">
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="form-group ">
                          <label>Phase</label>
                          <select  name="action_phase" id="" class="form-control">
                            ...
                            ?>
                                <option <?php if($row_data['action_phase'] == $row4['phase_id']){echo "selected";}else{echo "";} ?> value="<?php echo $row4['phase_id'] ?>"><?php echo $row4['phase_name'] ?></option>
                            <?php endwhile; ?>
                          </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select style="width: 100%;"  class=" js-example-basic-single form-control" id="id_label_single" name="action_owner" required>
                            ...
                            $query_responsible = "SELECT * FROM action_responsible WHERE a_action_id = {$_GET['action_id']} AND a_responsible_main = 1";
                    ...
                    <div class="form-group">
                        ...
                        <select style="width: 100%;" class=" js-example-basic-multiple form-control" id="id_label_multiple" name="responsible[]" multiple="multiple" > 
                            ...
                            while($row = mysqli_fetch_array($result)):
                                ...
                                $query_responsible = "SELECT * FROM action_responsible 
