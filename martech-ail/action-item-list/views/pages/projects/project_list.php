...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <div class="card-body">
            ...
            <table  style="font-size: 10px; vertical-align:middle; " class="table  order-column " id="dataTableExcel" width="100%" cellspacing="0">
                <thead>
                <tr>
                ...
                <tbody>
                    ...
                    if($_SESSION['quatroapp_user_level'] >= 1)
                    {
                        ...
                        WHERE project_active = 1 AND project_status != 1 AND lean = 0";
                    }
                    else
                    {
                        $query = "SELECT * FROM `projects` 
